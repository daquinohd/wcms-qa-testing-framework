...
public class AdvanceSearch {
	...
	//@FindBy(how=How.CSS, using=".select2-selection__rendered [placeholder='Select a subtype']") WebElement dpd_subTypeBox;
	...
	public void getCancerType(int cancerTypeIndex) throws InterruptedException {
	...
	public void getCancerSubType(String cancerSubType) throws InterruptedException {
		WebElement dpd_subTypeBox1 = driver.findElement(By.xpath(".//ul[@class='select2-selection__rendered']/li[@class='select2-search select2-search--inline']/input[@class='select2-search__field'][@placeholder='Select a subtype']"));
	...
	public void getCancerStage(String cancerStage) {
		...
		WebElement dpd_cancerStage = driver.findElement(By.xpath("//input[@class='select2-search__field' and @placeholder='Select a stage']"));
	...
	public void advSearch_CancerType_SubType(int cancerTypeIndex, String cancerSubType) throws InterruptedException {
		getCancerType(cancerTypeIndex);
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
	...
	public void advSearch_CancerType_SubType_Stage(int cancerTypeIndex, String cancerSubType, String cancerStage) throws InterruptedException {
		getCancerType(cancerTypeIndex);
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
		getCancerSubType(cancerSubType);
		driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
