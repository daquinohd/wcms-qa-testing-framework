...
public class ApiReference {
	...
	@FindBy(how=How.XPATH, using=".//*[@id='ui-id-4']") WebElement apiReferenceH3;
	@FindBy(how=How.XPATH, using=".//div[@class='api-reference-content']") WebElement apiReferenceContent;
	@FindBy(how=How.XPATH, using=".//a[@href='/syndication/api']") WebElement apiReferenceLink;
